# Guest Onboarding UI Spec

## Purpose

Defines the `GuestOnboarding.vue` component that renders the guest name-entry form. Covers the component's mounting contract with `HomeLive`, reactive avatar preview, and inline validation error display.
