...
Centralized runtime version management using mise (formerly rtx) to declare exact versions of Erlang, Elixir, and Node.js, ensuring parity between local development and CI environments.
