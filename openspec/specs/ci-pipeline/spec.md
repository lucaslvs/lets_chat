...
Automated continuous integration pipeline running on GitHub Actions to enforce code quality, security, type safety, and test coverage on every push to `main` and every pull request targeting `main`.
